...
@AllArgsConstructor
public class PostLeetcodeProblemTask {
    private final LeetcodeProblem leetcodeProblem;
    public void execute() {
        final JsonObject leetcodeProblemJson = leetcodeProblem.getEmbedJSON();
        ...
        try {
            final URL apiURL = new URL(MessageFormat.format(POST_MESSAGE_ENDPOINT_TEMPLATE, LEETCODE_CHANNEL_ID));
